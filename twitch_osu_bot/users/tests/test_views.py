...
from ..views import OsuUsernameView, UserDetailView, UserRedirectView
...
class TestUserRedirectView(BaseUserTestCase):
    def test_get_redirect_url(self):
        ...
        self.assertEqual(view.get_redirect_url(), "/profile/")
...
class TestOsuUsernameView(BaseUserTestCase):
    ...
    def test_get_success_url(self):
        ...
        #   self.make_user()
        self.assertEqual(self.view.get_success_url(), "/profile/")
